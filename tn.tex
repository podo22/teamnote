...
\usepackage{fontspec}
\usepackage{kotex}
\setmonofont{Monoplex KR Medium}
...
\Algorithm{Non-Recursive Segment Tree}{Segment tree for performance.}{$O(\log N)$/ query}{cpp}{source/2. Data structure/NonRec_SegTree.cpp}{}
\Algorithm{Merge Sort Tree}{Count/rank of elements in range $[L, R]$.}{$O(\log^2 N)$/ query}{cpp}{source/2. Data structure/MergeSortTree.cpp}{}
\tested
\Algorithm{Persistent Segment Tree}{Accessing previous versions and range k-th element.}{$O(\log N)$/ query}{cpp}{source/2. Data structure/PersistentSegmentTree.cpp}{}
\tested
