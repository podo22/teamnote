...
\usepackage{fontspec}
\usepackage{kotex}
\setmonofont{Monoplex KR}

\teamnote{2026}{A University}{A Team}
...
\Algorithm{Main Template}{Basic CP template with headers and defines.}{}{cpp}{source/0. Basic Implementation/main.cpp}{}

\section{Math}
\Algorithm{Basic Arithmetic}{Modular inverse, Extended Euclidean.}{}{cpp}{source/1. Math/Basic arithmetic.cpp}{}
...
\Algorithm{Erasable Priority Queue}{Priority queue supporting arbitrary element deletion.}{}{cpp}{source/2. Data structure/Erasable PQ.cpp}{}
\Algorithm{Non-Recursive Segment Tree}{Segment tree for performance.}{}{cpp}{source/2. Data structure/NonRec_SegTree.cpp}{}
...
\Algorithm{MCMF}{Minimum Cost Maximum Flow using SPFA/Dijkstra.}{$O(F \cdot E \log V)$}{cpp}{source/3. Graph/MCMF.cpp}{}
\Algorithm{SCC}{Strongly Connected Components (Tarjan's or Kosaraju's).}{$O(V+E)$}{cpp}{source/3. Graph/SCC.cpp}{}

\section{DP Optimization}
\Algorithm{Aliens Trick}{WQS Binary Search for DP optimization.}{$O(T \log X)$}{cpp}{source/4. DP/Aliens.cpp}{}
\Algorithm{Convex Hull Trick}{Optimization for DP with linear functions.}{$O(N \log N)$}{cpp}{source/4. DP/Convex Hull Trick.cpp}{}
\Algorithm{Linear CHT}{CHT when slopes/queries are monotonic.}{$O(N)$}{cpp}{source/4. DP/Linear CHT.cpp}{}

\section{Geometry}
\Algorithm{Geometry Template}{Basic point, line, and circle operations.}{}{cpp}{source/5. Geometry/Template.cpp}{}
\Algorithm{Convex Hull}{Monotone Chain or Graham Scan.}{$O(N \log N)$}{cpp}{source/5. Geometry/ConvexHull.cpp}{}

\Algorithm{Rotating Calipers}{Maximum distance/diameter of a convex hull.}{$O(N)$}{cpp}{source/5. Geometry/Calipers.cpp}{}
\Algorithm{Point in Convex Polygon}{Binary search based inclusion test.}{$O(\log N)$}{cpp}{source/5. Geometry/PointInConvexPolygon.cpp}{}
\Algorithm{Point in Polygon}{Ray casting algorithm for general polygons.}{$O(N)$}{cpp}{source/5. Geometry/PointInPolygon.cpp}{}
\Algorithm{Polar Sort}{Sorting points by angle.}{$O(N \log N)$}{cpp}{source/5. Geometry/PolarSort.cpp}{}
\Algorithm{Polygon Area}{Shoelace formula.}{$O(N)$}{cpp}{source/5. Geometry/PolygonArea.cpp}{}
\Algorithm{Segment Intersection}{Check if two line segments intersect.}{$O(1)$}{cpp}{source/5. Geometry/SegmentIntersection.cpp}{}
...
\section{STL \& pbds}
\Algorithm{Hash map}{Faster hash table using pb\_ds.}{$O(1)$}{cpp}{source/7. STL + pbds/Hash map(pbds).cpp}{}
\Algorithm{Ordered Set}{Set supporting order\_of\_key and find\_by\_order.}{$O(\log N)$}{cpp}{source/7. STL + pbds/Ordered Set(pbds).cpp}{}
...
\Algorithm{Priority Queue}{Meldable/Thin heaps from pb\_ds.}{$O(\log N)$}{cpp}{source/7. STL + pbds/Priority queue(pbds).cpp}{}
\Algorithm{Rope}{Fast insertions/deletions in large strings.}{$O(\log N)$}{cpp}{source/7. STL + pbds/Rope.cpp}{}
\Algorithm{Trie}{Prefix tree implementation from pb\_ds.}{}{cpp}{source/7. STL + pbds/Trie(pbds).cpp}{}

\section{Misc}
\Algorithm{Custom Hash}{Prevent anti-hash tests for unordered maps.}{}{cpp}{source/8. Misc/Custom hash.cpp}{}
\Algorithm{Fast I/O}{Fast integer I/O using fread/fwrite.}{}{cpp}{source/8. Misc/Fastio.cpp}{}
\Algorithm{Random}{Better seeding for mt19937.}{}{cpp}{source/8. Misc/Random.cpp}{}
